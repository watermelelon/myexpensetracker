...
// Function to simulate adding a new entry (In a real scenario, you'd extract details from uploaded receipts)
function addEntry(vendor, price) {
    data.push({ vendor, price });
    updateTable();
    updateChart();
}
